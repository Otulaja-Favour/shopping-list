...
document.addEventListener('DOMContentLoaded', () => {
        ...
        if (cart.length === 0) {
            ...
            confirmCheckoutBtn.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    modalBody.innerHTML = 'Checkout Successful!';
                }, 1000);
                cart = [];
                localStorage.setItem('cart', JSON.stringify(cart));
                updateCartUI();
    ...
    const timeoutModal = new bootstrap.Modal(document.getElementById('exampleModals'))
    function showModal() {
        timeoutModal.show()
    }
    wishlistIcon.addEventListener('click', (e) => {
        ...
        if (wishlistItems.length === 0) {
            modalBody.innerHTML = '<p>Your wishlist is empty.</p>';
        } else {
